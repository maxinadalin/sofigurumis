...
import ImageGalery from "components/products/ImageGalery";
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          ...
          <div className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
            ...
            <div className="mt-4 sm:mt-0">
              <Link to={"/DetallesOrden"}
                className="font-medium text-indigo-600 hover:text-indigo-500"
              >
                Ver todas los productos<span aria-hidden="true"> &rarr;</span>
              </Link>
            </div>
          </div>
              ...
              {products.map((product) => (
                ...
                >
                  <div className="sm:col-span-4 md:col-span-5 md:row-end-2 md:row-span-2">
                    ...
                    <ImageGalery photo={product && product.imageSrc} />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-12 md:col-span-7">
                    ...
                    {/* Billing */}
                    <div className="mt-10">
                      <div className="bg-gray-50 rounded-lg py-6 px-6 lg:px-0 lg:py-8 lg:grid lg:grid-cols-4 lg:gap-x-8">
