...
PROJECT_APPS = ['apps.user','user_profile']
ECOMMERCE_APPS = ['apps.categories','apps.products','apps.cart','apps.orders']
...
DATABASES = {
     "default": env.db("DATABASE_URL", default="postgres:///sofigurumi"),
 }
...
# if you want make a collectstatic, you should have this code line
